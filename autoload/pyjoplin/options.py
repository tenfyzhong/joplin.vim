...
map_note_info = vim.vars.get('joplin_map_note_info', '')
...
map_note_complete_convert = vim.vars.get('joplin_map_note_complete_convert',
                                         '')
map_tag_add = vim.vars.get('joplin_map_tag_add', '')
map_tag_del = vim.vars.get('joplin_map_tag_del', '')
map_resrouce_attach = vim.vars.get('joplin_map_resource_attach', '')
map_link_resource = vim.vars.get('joplin_map_link_resource', '')
map_link_note = vim.vars.get('joplin_map_link_note', '')
